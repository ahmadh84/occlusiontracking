classdef ReverseFlowConstancyFeature < AbstractFeature
    ...
    properties (Constant)
        NAN_VAL = 10;
        FEATURE_TYPE = 'Reverse Flow Constancy';
        FEATURE_SHORT_TYPE = 'RC';
    end
    
    
    methods
        function obj = ReverseFlowConstancyFeature( cell_flows, varargin )
        ...
        function [ revflowconst feature_depth ] = calcFeatures( obj, calc_feature_vec )
            ...
            if obj.no_scales > 1
                ...
                for scale_idx = 1:obj.no_scales
                    ...
                    for algo_idx = 1:no_flow_algos
                        ...
                        reverse_dist(outside_idcs) = ReverseFlowConstancyFeature.NAN_VAL;
