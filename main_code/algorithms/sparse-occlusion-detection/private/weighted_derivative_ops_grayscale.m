function [D1 D2] = weighted_derivative_ops_grayscale(M, N, I0, beta, nu)
% WEIGHTED_DERIVATIVE_OPS_GRAYSCALE  Computes the weighted derivative operators
%	                                   in x- and y-direction
% 
% [D1, D2] = WEIGHTED_DERIVATIVE_OPS_GRAYSCALE(M,N, I0, BETA, NU)
% INPUT: 
%	  M,N     : Image size
