...
%SUBSASGN   Modify parameters of HS optical flow algorithm
%   THIS = SUBSASGN(THIS, SEL, VAL) sets parameter of a HS optical
%   flow algorithm THIS using given selector SEL to value VAL.  The
