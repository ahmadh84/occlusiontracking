...
%%%%%%%%%%%%%%%%
override_settings.cell_features = { OFLengthVarianceFeature(nhood, uv_ftrs2_ss_info) };
...
%%%%%%%%%%%%%%%%
override_settings.cell_features = { OFCollidingSpeedFeature(nhood_cs, uv_ftrs2_ss_info) };
