...
% override_settings.cell_features = { FlowConfidenceFeature(override_settings.cell_flows, [4 5 9 10 11 12 13 14 18 19], '../../Data/oisin+middlebury', 50, 60) };
% trainTestDelete(testing_seq, training_seq, main_dir, temp_out_dir, override_settings);
%
%%% FA %%%
temp_out_dir = fullfile(out_dir, 'fa');
override_settings.cell_features = { FlowAngleVarianceFeature(override_settings.cell_flows, uv_ftrs1_ss_info) };
trainTestDelete(testing_seq, training_seq, main_dir, temp_out_dir, override_settings);

%%% FN %%%
temp_out_dir = fullfile(out_dir, 'fn');
override_settings.cell_features = { FlowLengthVarianceFeature(override_settings.cell_flows, uv_ftrs1_ss_info) };
trainTestDelete(testing_seq, training_seq, main_dir, temp_out_dir, override_settings);
% 
% %%% All features %%%
