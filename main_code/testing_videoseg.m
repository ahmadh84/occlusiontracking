function [ output_args ] = testing_videoseg( input_args )
...
%   Detailed explanation goes here
    ...
    temp_out_dir = fullfile(out_dir, 'FINAL-ed_pb_pb_pc_st_stm_tg_av_lv_cs-max_rc_ra_fc_fc_fa_fn_sp_RCGT');
    ...
    return;
    MAIN_CLASS_XML_PATH = fullfile(temp_out_dir, '1001110_class.xml');
...
%     trainTestDelete('trainTestDeleteMain', testing_seq, MAIN_CLASS_XML_PATH, seq_conflicts, main_dir, eval_temp_out_dir, override_settings);
    ...
    main_dir = '../../../Data/Images/UCL/evaluation_data/gabriel-supplementary/Sigal_Seq15';
...
%                                      LargeDisplacementOF };
    ...
    override_settings.cell_features = { EdgeDistFeature(override_settings.ss_info_im1), ...
                                        ...
                                        FlowConfidenceFeature(override_settings.cell_flows, [9 10 17 18 19 22 24 26 29 30 39 49 50], seq_conflicts, '../../../Data/Images/UCL/oisin+middlebury', 1, 1), ...
